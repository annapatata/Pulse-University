...
-- Bands (artist_nband = FALSE)
(1, 'The Killers', FALSE, NULL, 1),
(2, 'Arctic Monkeys', FALSE, NULL, 2),
(3, 'Foo Fighters', FALSE, NULL, 3),
(4, 'Florence + Machine', FALSE, NULL, 4),
(5, 'Tame Impala', FALSE, NULL, 5),
(6, 'The Strokes', FALSE, NULL, 6),
(7, 'Red Hot Chili Peppers', FALSE, NULL, 7),
(8, 'Muse', FALSE, NULL, 8),
(9, 'LCD Soundsystem', FALSE, NULL, 9),
(10, 'The National', FALSE, NULL, 10),
(11, 'Vampire Weekend', FALSE, NULL, 11),
(12, 'Arcade Fire', FALSE, NULL, 12),
(13, 'The Black Keys', FALSE, NULL, 13),
(14, 'Phoenix', FALSE, NULL, 14),
(15, 'Interpol', FALSE, NULL, 15),
(16, 'The 1975', FALSE, NULL, 16),
(17, 'Queens of the Stone Age', FALSE, NULL, 17),

-- Solo artists from bands (artist_nband = TRUE)
(18, 'Brandon Flowers', TRUE, 1, NULL),
(19, 'Alex Turner', TRUE, 5, NULL),
(20, 'Dave Grohl', TRUE, 9, NULL),
(21, 'Florence Welch', TRUE, 14, NULL),
(22, 'Kevin Parker', TRUE, 16, NULL),
(23, 'Julian Casablancas', TRUE, 19, NULL),
(24, 'Anthony Kiedis', TRUE, 22, NULL),
(25, 'Matt Bellamy', TRUE, 26, NULL),
(26, 'James Murphy', TRUE, 29, NULL),
(27, 'Matt Berninger', TRUE, 32, NULL),
(28, 'Ezra Koenig', TRUE, 35, NULL),
(29, 'Win Butler', TRUE, 38, NULL),
(30, 'Dan Auerbach', TRUE, 41, NULL),
(31, 'Thomas Mars', TRUE, 43, NULL),
(32, 'Paul Banks', TRUE, 46, NULL),
(33, 'Matty Healy', TRUE, 49, NULL),
(34, 'Josh Homme', TRUE, 53, NULL),

-- Additional solo pop artists (artist_nband = TRUE)
(35, 'Taylor Swift', TRUE, 61, NULL),
(36, 'Ariana Grande', TRUE, 62, NULL),
(37, 'Billie Eilish', TRUE, 63, NULL),
(38, 'Dua Lipa', TRUE, 64, NULL),
(39, 'Harry Styles', TRUE, 65, NULL),
(40, 'Olivia Rodrigo', TRUE, 66, NULL),
(41, 'Doja Cat', TRUE, 67, NULL),
(42, 'The Weeknd', TRUE, 68, NULL),
(43, 'Post Malone', TRUE, 69, NULL),
(44, 'Camila Cabello', TRUE, 70, NULL),
(45, 'Shawn Mendes', TRUE, 71, NULL),
(46, 'Selena Gomez', TRUE, 72, NULL),
(47, 'Justin Bieber', TRUE, 73, NULL),
(48, 'Lady Gaga', TRUE, 74, NULL),
(49, 'Bruno Mars', TRUE, 75, NULL),
(50, 'Ed Sheeran', TRUE, 76, NULL),
(51, 'Rihanna', TRUE, 77, NULL),
(52, 'Beyoncé', TRUE, 78, NULL),
(53, 'Katy Perry', TRUE, 79, NULL),
(54, 'Adele', TRUE, 80, NULL),
(55, 'Miley Cyrus', TRUE, 81, NULL),
(56, 'Nicki Minaj', TRUE, 82, NULL),
(57, 'Drake', TRUE, 83, NULL),
(58, 'Lizzo', TRUE, 84, NULL),
(59, 'Charlie Puth', TRUE, 85, NULL),
(60, 'Halsey', TRUE, 86, NULL),
(61, 'Zayn', TRUE, 87, NULL),
(62, 'Lil Nas X', TRUE, 88, NULL),
(63, 'Sam Smith', TRUE, 89, NULL),
(64, 'SZA', TRUE, 90, NULL);
